...
World::World(int side, WorldCell out /* = {0, 0, 0}*/) {
	_out = out;
	_side = side;
	_side2 = side * side;
...
int World::side() const { return this->_side; }
int World::size() const { return this->_side3; }

WorldCell World::get(int i) const { return this->_data[i]; }
void World::set(WorldCell value, int i) const { this->_data[i] = value; }

WorldCell World::get(int x, int y, int z) const {
...
void World::set(WorldCell value, int x, int y, int z) const {
	const int cx = x * this->_side2;
	const int cy = y * this->_side;
	const int cz = z;
...
int World::countMoore(int status, int x, int y, int z) const {
	// TODO: Improve ?
	int result = 0;
...
int World::countNeumann(int status, int x, int y, int z) const {
	// TODO: Improve ?
	int result = 0;
